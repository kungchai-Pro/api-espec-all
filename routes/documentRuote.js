...
router.get('/JournalSuccessfullylist',DocumentController.getJournalSuccessfully);// รายการที่เสร็จแล้ว
router.get('/JournalNotSuccessfullylist',DocumentController.getJournalNotSuccessfully);// รายการที่ยังไม่เสร็จ
